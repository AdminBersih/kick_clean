            ...
            <section class="service-details">
                <div class="container">
                        ...
                        <div class="row">
                            <div class="col-xl-4 col-lg-8 order-2">
                                <div class="service-details__sidebar">
                                    ...
                                    <ul class="service-details__sidebar-list">
                                        ...
                                        <li class="service-details__sidebar-list-item"><Link href="/house-cleaning" class="active">Treatment Sepatu & Tas</Link></li>
                            ...
                            <div class="col-xl-8 order-1">
                                <div class="service-details__top-img">
                                    <img src="/assets/images/resources/service-details-img1.jpg" alt="Treatment" />
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="service-details__bottom">
                        <h2 class="service-details__bottom-title">Jasa Treatment Sepatu & Tas</h2>
                        <div class="service-details__bottom-text1">
                            <p>Treatment cocok untuk menjaga warna dan tekstur setelah proses cuci atau repaint.</p>
                        </div>
                        <div class="service-details__bottom-text2">
                            <p>Kami menyediakan coating anti air, anti noda, dan deodorizing untuk mencegah jamur.</p>
                        </div>
                        <div class="service-details__bottom-text3">
                            <div class="row">
                                <div class="col-xl-4 col-lg-5">
                                    <div class="img-box">
                                        <img src="/assets/images/resources/service-details-img2.jpg" alt="Treatment Kick Clean" />
                                    </div>
                                </div>
                                <div class="col-xl-8 col-lg-7">
                                    <div class="content-box">
                                        <p>Untuk bahan kulit atau suede kami memakai protector khusus yang tidak merubah warna.</p>

                                        <ul>
                                            <li><span class="icon-plus"></span> Coating bertahan 2-3 bulan tergantung penggunaan.</li>
                                            <li><span class="icon-plus"></span> Termasuk deodorizing dan penyimpanan dengan silica gel.</li>
                                        </ul>
                                    </div>
                                </div>
                            </div>
